...
INSERT INTO PublicServant (uid, department) VALUES
(1,  'Dept1'),
(2,  'Dept2'),
(3,  'Dept3'),
(4,  'Dept1'),
...
INSERT INTO Doctor (uid, degree) VALUES
(11, 'DoM'),
(12, 'MoC'),
(13, 'MoM'),
(14, 'DoM'),
...
INSERT INTO Specialize (id, uid) VALUES
(5,  11),
(10, 11),
(2,  12),
(9,  12),
...
INSERT INTO Record (uid, cname, disease_code, total_deaths, total_patients) VALUES
(1,  'China',         'copad-10',  300793, 1100063),
(1,  'China',         'covid-19',  152939, 1221112),
(2,  'India',         'cobad-11',  611164,  721404),
(3,  'United States', 'covid-12',  109827,  309311),
(4,  'Indonesia',     'cofud-13',  107172,  705327),
(4,  'China',         'covid-19',  502089,  767983),
(5,  'Pakistan',      'copad-14',  768065,  946722),
(5,  'Pakistan',      'covid-19', 1132950, 1332235),
(6,  'Brazil',        'cobad-15', 1399530,  544960),
(7,  'Nigeria',       'cobad-16', 1048302,  916301),
(7,  'Nigeria',       'covid-19',  894710,  927695),
(8,  'Bangladesh',    'covid-17',  642778, 1278944),
(9,  'Russia',        'cofud-18',  545848, 1446607),
(10, 'Mexico',        'covid-19',  771370, 1203274),
(10, 'Russia',        'covid-19',  168087, 1196071),
(10, 'Bangladesh',    'covid-19',  398701,  608148),
(10, 'China',         'covid-19',  838077, 1350346);